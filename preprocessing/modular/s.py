...
class WellSummaryProcessor:
    def __init__(self, summary_path):
        ...
        summary_columns = ["WOPR:*", "WWPR:*", "WGPR:*", "WBHP:*", "WOPT:*", "WWPT:*", "WGPT:*"]
        ...
        summary_df = summary_df.stack(level=1).rename_axis(("INDEX", *summary_index, "WELL")).reset_index([*summary_index, "WELL"])
